...
QT_MOC_LITERAL(1, 6, 13), // "enemyDefeated"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 6), // "Enemy*"
QT_MOC_LITERAL(4, 28, 5), // "enemy"
QT_MOC_LITERAL(5, 34, 4) // "move"

    },
    "Enemy\0enemyDefeated\0\0Enemy*\0enemy\0"
    "move"
};
...
void Enemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->enemyDefeated((*reinterpret_cast< Enemy*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Enemy::enemyDefeated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Enemy::enemyDefeated(Enemy * _t1)
{
